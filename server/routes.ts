...
export async function registerRoutes(
  ...
  app.get("/api/tickets/:ticketId/activity", async (req, res) => {
    try {
      const activity = await storage.getTicketActivity(req.params.ticketId);
      res.json(activity);
    } catch (error: any) {
      res.status(500).json({ error: error.message });
    }
  ...
  app.post("/api/tickets/:ticketId/activity", async (req, res) => {
    try {
  ...
  // AI Ticket Analysis - analyze ticket description and suggest routing
  app.post("/api/ai/analyze-ticket", async (req, res) => {
    try {
      ...
      const { findSimilarTicketsAndDocs } = await import("./embeddings");
      const { suggestTicketRouting } = await import("./ai-routing");
      
      const similarResults = await findSimilarTicketsAndDocs(description);
      const suggestion = await suggestTicketRouting(description, similarResults);
  ...
  // AI Ticket Search - semantic search for tickets
  app.post("/api/ai/search-tickets", async (req, res) => {
    try {
      ...
      const { searchTicketsBySemantic } = await import("./embeddings");
      const results = await searchTicketsBySemantic(query);
      res.json(results);
    } catch (error: any) {
      console.error("AI ticket search error:", error);
      res.json([]);
    }
  });

  // Helpdesk Routing Configuration
  app.get("/api/helpdesks/:helpdeskId/routing-config", async (req, res) => {
    try {
      const config = await storage.getHelpdeskRoutingConfig(req.params.helpdeskId);
      res.json(config || null);
    } catch (error: any) {
      res.status(500).json({ error: error.message });
    }
  ...
  app.post("/api/helpdesks/:helpdeskId/routing-config", async (req, res) => {
    try {
      const config = await storage.createHelpdeskRoutingConfig({
  ...
  app.patch("/api/helpdesks/:helpdeskId/routing-config", async (req, res) => {
    try {
      const config = await storage.updateHelpdeskRoutingConfig(req.params.helpdeskId, req.body);
      res.json(config);
    } catch (error: any) {
      res.status(500).json({ error: error.message });
    }
  ...
  app.get("/api/helpdesks/:helpdeskId/escalation-config", async (req, res) => {
    try {
      const config = await storage.getHelpdeskEscalationConfig(req.params.helpdeskId);
      res.json(config || null);
    } catch (error: any) {
      res.status(500).json({ error: error.message });
    }
  ...
  app.post("/api/helpdesks/:helpdeskId/escalation-config", async (req, res) => {
    try {
      const config = await storage.createHelpdeskEscalationConfig({
        helpdeskId: req.params.helpdeskId,
        ...req.body,
      });
      res.json(config);
  ...
  app.patch("/api/helpdesks/:helpdeskId/escalation-config", async (req, res) => {
    try {
      const config = await storage.updateHelpdeskEscalationConfig(req.params.helpdeskId, req.body);
      res.json(config);
    } catch (error: any) {
      res.status(500).json({ error: error.message });
    }
  ...
  // Escalation Path
  app.get("/api/helpdesks/:helpdeskId/escalation-path", async (req, res) => {
    try {
      const path = await storage.getEscalationPath(req.params.helpdeskId);
      res.json(path);
    } catch (error: any) {
      res.status(500).json({ error: error.message });
    }
  ...
  app.post("/api/helpdesks/:helpdeskId/escalation-path", async (req, res) => {
    try {
      const step = await storage.createEscalationPathStep({
        helpdeskId: req.params.helpdeskId,
        ...req.body,
      });
      res.json(step);
  ...
  app.delete("/api/escalation-path/:id", async (req, res) => {
    try {
      await storage.deleteEscalationPathStep(req.params.id);
      res.sendStatus(204);
    } catch (error: any) {
      res.status(500).json({ error: error.message });
    }
